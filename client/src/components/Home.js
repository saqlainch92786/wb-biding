          ...
          <div className='row rt-breadcump-height align-items-center'>
            <div className='col-lg-12 mx-auto text-center text-white'>
              <h4 className='f-size-70 f-size-lg-50 f-size-md-40 f-size-xs-24 rt-strong'>
                Welcome to Online Bid-It System
              </h4>
              <h4 className='f-size-36 f-size-lg-30 f-size-md-24 f-size-xs-16 rt-light3'>
                We provide you the place for your next Ad
              </h4>
            </div>
            {/* /.col-12 */}
          </div>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-xl-8 col-lg-10'>
              <h2 className='rt-section-title'>BID-IT Auctions System</h2>
              <p className='rt-light3 f-size-18 line-height-34'>
                Welcome to the world's leading platform for buyers and
                sellers.Bid-It is the world’s free marketplace, listing more
                than 7 million products available for sale and purchase more
                than 5 million successful sales.Whether you are a product buyer
                or a product seller, Bid-It is the most trusted name in Online
                Auction.
              </p>
              ...
              <ul className='rt-list'>
                ...
                <li className='f-size-18 line-height-34 clearfix rt-mb-8'>
                  <img
                    ...
                    className='rt-mr-5 '
                  />
                  Product Sellers achieve industry-high average sale prices
                </li>
                <li className='f-size-18 line-height-34 clearfix rt-mb-8'>
                  <img
                    src={checkicon}
